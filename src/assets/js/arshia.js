...
$window.on('load', function () {
    ...
    scrollToAnchor()
    customScrollbar()
    // portfolioIsotop() -- deshabilitado, el portfolio usa Angular layout
    owlCrousel()
})
...
function sidebarMenu() {
    ...
    $menuLink.on('click', function () {
        ...
        if (
            not_allowed.indexOf($id) > -1 ||
            not_allowed.indexOf($thisId) > -1
        ) {
            if (
                not_allowed.indexOf($thisId) >= 0 &&
                not_allowed.indexOf($id) >= 0
            ) {
                $('.menu > li a').removeClass('active')
        ...
        if ($id == '#portfolio') {
            // portfolioIsotop() deshabilitado -- Angular maneja el layout
        }
        $lastHash = 1
    })
        ...
        if ($('body')) {
            ...
            ;((window.onmousemove = function (s) {
                ...
                $('body').on(
                    ...
                    function () {
                        ;(e.classList.add('mmc-hover'),
                            t.classList.add('mmc-hover'))
                    }
                ),
                $('body').on(
                    'mouseleave',
                    ...
                    function () {
                        ;($(this).is('a') &&
                            ...
                            (e.classList.remove('mmc-hover'),
                            t.classList.remove('mmc-hover'))
                    }
                ),
